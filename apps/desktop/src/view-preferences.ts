...
const coreColumns: PlayerColumnDefinition[] = [
  ...
  { id: "secondary_nationalities", label: "Weitere Nationen", category: "Basis" },
  { id: "preferred_foot", label: "Starker Fuß", category: "Basis" },
  { id: "height_cm", label: "Größe (cm)", category: "Basis" },
  { id: "weight_kg", label: "Gewicht (kg)", category: "Basis" },
  { id: "skin_tone", label: "Hautton", category: "Basis" },
  { id: "hair_colour", label: "Haarfarbe", category: "Basis" },
  { id: "hair_length", label: "Haarlänge", category: "Basis" },
  { id: "ethnicity", label: "Ethnizität", category: "Basis" },
  { id: "preferred_moves", label: "Bevorzugte Spielzüge", category: "Basis" },
