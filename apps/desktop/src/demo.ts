...
export const demoPlayers: Player[] = [
  ...
  { id: "102", name: "Mateo Silva", age: 21, club, nationality: "Portugal", positions: ["OM (L)", "ST"], preferred_foot: "left", value: 18_000_000, wage: 24_000, current_ability: 137, potential_ability: 169, attributes: attributes(14, 15, 18, 17), details: details(2028) },
  { id: "103", name: "Elias Berg", age: 18, club, nationality: "Dänemark", positions: ["DM", "M (Z)"], preferred_foot: "both", value: 7_800_000, wage: 9_200, current_ability: 116, potential_ability: 181, attributes: attributes(16, 17, 13, 16), details: details(2030) },
  { id: "104", name: "Amadou Koné", age: 23, club, nationality: "Mali", positions: ["V (Z)"], preferred_foot: "right", value: 21_000_000, wage: 31_000, current_ability: 146, potential_ability: 158, attributes: attributes(12, 11, 16, 13), details: details(2028) },
  ...
  { id: "111", name: "Miro Petrovic", age: 32, club, nationality: "Kroatien", positions: ["M (Z)"], preferred_foot: "both", value: 7_000_000, wage: 42_000, current_ability: 153, potential_ability: 153, attributes: attributes(18, 17, 11, 18), details: details(2027) },
