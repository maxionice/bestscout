...
const basicFields: Record<EditEntityKind, EditorField[]> = {
  player: [
    ...
    field("details.secondary_nationalities", "Weitere Nationalitäten", "Identität", "list"),
    field("details.appearance", "Erscheinungsbild (JSON)", "Erscheinungsbild", "json"),
    field("details.appearance.height_cm", "Größe (cm)", "Erscheinungsbild", "integer", true, 100, 250),
    field("details.appearance.weight_kg", "Gewicht (kg)", "Erscheinungsbild", "integer", true, 30, 250),
    field("details.appearance.skin_tone", "Hautton", "Erscheinungsbild", "integer", true, 1, 20),
    { ...field("details.appearance.hair_colour", "Haarfarbe", "Erscheinungsbild", "enum"), options: ["black", "brown", "blond", "red", "grey", "white", "other", "unknown"] },
    { ...field("details.appearance.hair_length", "Haarlänge", "Erscheinungsbild", "enum"), options: ["bald", "short", "medium", "long", "unknown"] },
    field("details.appearance.ethnicity", "Ethnizität", "Erscheinungsbild", "string", true),
    field("details.preferred_moves", "Bevorzugte Spielzüge (JSON)", "Spielweise", "json"),
    ...
    field("details.contract.bonuses", "Vertragsboni (JSON)", "Vertrag", "json"),
    field("details.contract.clauses", "Vertragsklauseln (JSON)", "Vertrag", "json"),
  ...
  staff: [
    ...
    field("contract.bonuses", "Vertragsboni (JSON)", "Vertrag", "json"),
    field("contract.clauses", "Vertragsklauseln (JSON)", "Vertrag", "json"),
