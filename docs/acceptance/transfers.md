...
- Add reciprocal atomic execution and UI selection for player swaps.
...
Canonical immediate/future/loan behavior is complete. The 1.0 transfer parity
gate remains open until reciprocal swaps and live adapter acceptance pass.
