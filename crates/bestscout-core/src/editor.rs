            ...
            is_attribute_path(field)
                || matches!(
                    ...
                    "name"
                        ...
                        | "details.contract.bonuses"
                        | "details.contract.clauses"
                        ...
                        | "details.appearance"
                        | "details.appearance.height_cm"
                        | "details.appearance.weight_kg"
                        | "details.appearance.skin_tone"
                        | "details.appearance.hair_colour"
                        | "details.appearance.hair_length"
                        | "details.appearance.ethnicity"
